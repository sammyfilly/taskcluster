        ...
        ** OPTIONAL ** properties
        =========================
          ...
          livelogExposePort                 When not using websocktunnel, livelog would be exposed using this port.
                                            ...
                                            [default: 0]
          loopbackAudioDeviceNumber         The audio loopback device number. The resulting devices will take the form
                                            controlC<DEVICE_NUMBER>, pcmC<DEVICE_NUMBER>D0c, pcmC<DEVICE_NUMBER>D0p,
                                            pcmC<DEVICE_NUMBER>D1c, pcmC<DEVICE_NUMBER>D1p where <DEVICE_NUMBER> is
                                            an integer between 0 and 31. This setting may be used to change it.
                                            [default: 16]
